...
def main():
    ...
    while True:
        try:
            input_data = input("Masukkan angka (atau ketik 'end' untuk menghitung standar deviasi): ")
            if input_data.lower() == 'end':
                break
            data.append(float(input_data))
        except ValueError:
            print("Masukkan angka atau 'end' untuk menghitung standar deviasi.")
    ...
    if data:
        ...
        print("Tidak ada data untuk dihitung standar deviasi.")
